...
#### 制作技法库（production_skills）

本系统集成了 **98 个原子化制作技法 skills**，覆盖 8 大领域：灯光摄影、调色、镜头设计、场景转换、声音设计、摄影机锚定、导演技艺、故事结构。通过 `activate_production_skill` 工具按需加载。

**使用方法**：
1. 遇到具体技法决策时，先加载 `production_skills/INDEX.md` 获取域路由表
2. 根据触发信号匹配目标子域 INDEX，加载子域路由表
3. 匹配精确 skill 并激活，按 R→I→A1→A2→E→B 六段执行
4. **关键决策点必须激活对应 skill 获取精确指导**，不可仅凭综合文档泛泛处理

**关键技法决策触发场景**：

| 规划维度 | 遇到以下问题时 | 应激活的 skill 域 |
|----------|--------------|-------------------|
| ②视觉风格/构图 | 该用对称构图还是三分法？运镜动机是什么？ | `shot_design/INDEX.md` |
| ②视觉风格/灯光 | 场景需要硬光还是软光？灯光方向如何选择？ | `cinematography/INDEX.md` |
| ③叙事节奏 | 段落间张力断了怎么办？ | `directing/INDEX.md` |
| ④分场景镜头 | 对话场景站位怎么设计？观众应该认同谁？ | `shot_design/INDEX.md` |
| ⑤声音方向 | 环境音怎么选择？什么时候用静默？ | `sound_design/INDEX.md` |
| ⑥转场 | 场间转场用硬切还是叠化？如何做情绪缓冲？ | `scene_transitions/INDEX.md` |
